...
export default function Login() {
  ...
  return (
    <div className="min-h-screen pt-40 md:pt-44 flex flex-col items-center justify-center bg-pink-100 w-full">
      <h1 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">Log in</h1>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-sm bg-white p-8 rounded-2xl shadow-md">
        ...
        <button type="submit" className="bg-gray-800 text-white font-bold rounded-full px-6 py-2 text-lg hover:bg-gray-900 transition">Log in</button>
