    ...
    <div className="w-full absolute top-0 left-0 z-50 ">
      <div className="xl:p-13 w-full flex justify-center">
        <div className="flex justify-between items-center p-3 sm:p-5 md:p-6 lg:p-8 rounded-full mx-auto bg-white relative top-4 left-0 w-full max-w-[1300px] shadow-md transition-all duration-300">
          ...
          <div className={`flex-col lg:flex-row lg:flex gap-3 md:gap-5 items-center absolute lg:static top-20 left-0 w-full lg:w-auto bg-white lg:bg-transparent shadow-md lg:shadow-none transition-all duration-300 z-40 rounded-b-2xl lg:rounded-none ${menuOpen ? 'flex' : 'hidden lg:flex'}`}>
            <ul className='flex flex-col lg:flex-row gap-3 md:gap-5 items-center w-full lg:w-auto'>
              <Link href="/">
            ...
            <div className="btns flex flex-col lg:flex-row gap-2 md:gap-3 lg:gap-5 items-center w-full lg:w-auto px-4 lg:px-0 pb-3 lg:pb-0">
              <Link href="/login" className="w-full lg:w-auto"><button type="button" className="text-white font-bold bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 rounded-full px-4 md:px-5 py-2 text-sm md:text-md lg:text-lg cursor-pointer dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 w-full lg:w-auto">Log in</button></Link>
              <Link href="/signup" className="w-full lg:w-auto"><button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-bold rounded-full px-4 md:px-5 py-2 text-sm md:text-md lg:text-lg cursor-pointer dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 w-full lg:w-auto">Sign up free</button></Link>
            </div>
          </div>
        </div>
      </div>
